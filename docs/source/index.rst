...
======================================
The Research Computing Cluster is a cloud-native (hybrid-capable), autoscaling cluster that deploys on Google Cloud. The RCC comes with a Slurm job scheduler
